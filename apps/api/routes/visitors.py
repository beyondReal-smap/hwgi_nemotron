...
class VisitorTrackRequest(BaseModel):
    ...
    event_type: str = Field(default="page_view", min_length=1, max_length=50)
    action: str | None = Field(default=None, max_length=80)
    target_tag: str | None = Field(default=None, max_length=40)
    ...
    target_href: str | None = Field(default=None, max_length=500)
